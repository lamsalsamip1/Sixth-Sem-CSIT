...
namespace ProductAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Product>>> GetProduct()
        {
            ...
            var productsWithCategoryNames = await _context.Product
                ...
                .Select(p => new Product
                {
                    ...
                    Category = new Category { category_name = p.Category.category_name } // Include only the category_name in the Category object
                })
                .ToListAsync();
