...
namespace PlayerValidaton.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(PlayerValidatonContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("player_id,player_name,age,nationality,position,contract_expiry")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("player_id,player_name,age,nationality,position,contract_expiry")] Player player)
        {
