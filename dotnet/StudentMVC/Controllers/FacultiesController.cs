...
namespace StudentMVC.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public FacultiesController(StudentMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("faculty_id,name")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("faculty_id,name")] Faculty faculty)
        {
